...
def ctags_task_func(show_message_enable, s_time, cscope_task_id):
    ...
    if 'cscope_and_ctags' == sys.argv[2]:
        ...
        # The commonly used head dir of Linux C programming
        ctags_cmd = ctags_cmd + " ; ctags -f ${HOME}/systags --c-kinds=+p --fields=+S"
        ...
        ctags_cmd = ctags_cmd + " /usr/include/netash/* "
        ctags_cmd = ctags_cmd + " /usr/include/netatalk/* "
        ctags_cmd = ctags_cmd + " /usr/include/neteconet/* "
        ctags_cmd = ctags_cmd + " /usr/include/netinet/* "
        ctags_cmd = ctags_cmd + " /usr/include/netpacket/* "
        ctags_cmd = ctags_cmd + " /usr/include/nfs/* "
        ctags_cmd = ctags_cmd + " /usr/include/openssl/* "
        ctags_cmd = ctags_cmd + " /usr/include/protocols/* "
        ctags_cmd = ctags_cmd + " /usr/include/python2.7/* "
        ctags_cmd = ctags_cmd + " /usr/include/readline/* "
        #ctags_cmd = ctags_cmd + " /usr/include/rpc/* "
        #ctags_cmd = ctags_cmd + " /usr/include/scsi/* "
        #ctags_cmd = ctags_cmd + " /usr/include/sound/* "
        #ctags_cmd = ctags_cmd + " /usr/include/tcl/* "
        #ctags_cmd = ctags_cmd + " /usr/include/uapi/* "
        ctags_cmd = ctags_cmd + " /usr/include/video/* "
        ctags_cmd = ctags_cmd + " /usr/include/x86_64-linux-gnu/* "
        #ctags_cmd = ctags_cmd + " /usr/include/x86_64-linux-gnu/asm/* "
        #ctags_cmd = ctags_cmd + " /usr/include/x86_64-linux-gnu/bits/* "
        #ctags_cmd = ctags_cmd + " /usr/include/x86_64-linux-gnu/gnu/* "
        #ctags_cmd = ctags_cmd + " /usr/include/x86_64-linux-gnu/openssl/* "
        ctags_cmd = ctags_cmd + " /usr/include/x86_64-linux-gnu/python2.7/* "
        ctags_cmd = ctags_cmd + " /usr/include/x86_64-linux-gnu/sys/* "
